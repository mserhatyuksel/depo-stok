...
<body>
    ...
    $sonuc = mysqli_query($baglan, "INSERT INTO urun(UrunID,urunadi,Kategori_id,Urun_birimi,U_alisfiyat,U_satisfiyat,Stok) VALUES ('$UrunID','$urunadi','$Kategori_id','$Urun_birimi','$U_alisfiyat','$U_satisfiyat','$Stok')");
